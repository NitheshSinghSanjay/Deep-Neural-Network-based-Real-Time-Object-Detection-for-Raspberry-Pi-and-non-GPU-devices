...
# model_path = 'trained_weights/new_mobv2_epoch-45_val_loss-2.0145.h5'
model_path = 'new_test.h5'
...
tf.train.write_graph(frozen_graph, "model", "mnet_fast_inference.pb", as_text=False)